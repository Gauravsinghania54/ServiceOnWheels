				...
				<div class="container">
					...
					<div class="navbar-collapse collapse" id="ftheme">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="active"><a href="searchdata.php">Find the</a></li>
...
?>
  ...
  <input type="hidden" name="longi" id="longi" placeholder="Longitude"/>
      <input type="hidden" name="lati" id="lati" placeholder="Latitude"/>
