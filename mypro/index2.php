...
<body id="top" data-spy="scroll">
				...
				<div class="container">
					...
					<div class="navbar-collapse collapse" id="ftheme">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="active"><a href="index2.php">Find the Tutor</a></li>
							<li><a href="index3.php">Find the Learner</a></li>
	...
	<div id="search-form">
			<form class="form-container" action="">
				<input type="text" class="search-field" value="Course Keywords" />
